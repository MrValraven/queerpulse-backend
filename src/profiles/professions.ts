...
export const PROFESSIONS_BY_DISCIPLINE: Record<string, readonly string[]> = {
  ...
  food: ['chef', 'barista', 'baker', 'supperClubHost', 'bartender', 'waiter'],
  ...
  care: ['homeCareWorker', 'childcareWorker', 'disabilitySupportWorker'],
  wellness: ['personalTrainer', 'yogaTeacher', 'massageTherapist'],
  retail: [
    'shopAssistant',
    'receptionist',
    'cleaner',
  ...
  transport: ['driver', 'deliveryRider', 'warehouseWorker'],
