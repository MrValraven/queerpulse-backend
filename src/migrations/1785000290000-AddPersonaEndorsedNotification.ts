...
export class AddPersonaEndorsedNotification1785000290000 implements MigrationInterface {
  name = 'AddPersonaEndorsedNotification1785000290000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "notifications_type_enum" ADD VALUE IF NOT EXISTS 'persona_endorsed'`,
    );
  }
