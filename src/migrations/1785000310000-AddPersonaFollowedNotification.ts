...
export class AddPersonaFollowedNotification1785000310000 implements MigrationInterface {
  name = 'AddPersonaFollowedNotification1785000310000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "notifications_type_enum" ADD VALUE IF NOT EXISTS 'persona_followed'`,
    );
  }
