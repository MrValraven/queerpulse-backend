...
/**
 * `GET /admin/ban-evasion/join-requests?ids=a,b,c`.
 *
 * Addressed by join-request ID only, never by a raw email in the query string:
 * a staff member can assess a request that is in front of them in the queue,
 * and there is no way to use this endpoint to ask "has this arbitrary address
