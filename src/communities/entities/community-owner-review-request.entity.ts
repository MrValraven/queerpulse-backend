 ...
 * the owner is fine); `withdrawn` is the requesting moderator taking it back.
...
/**
 * A community's moderators jointly flagging that their owner is unreachable,
 * so platform staff can look at reassigning the community.
 *
...
export class CommunityOwnerReviewRequest {
  ...
  // The moderator who filed it. Nullable and `ON DELETE SET NULL` for account
  ...
  // Why the moderators think the owner is gone. Staff-facing.
